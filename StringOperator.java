    ...
    for (int i = 0; i < input.length(); i++) {
        ...
        if (Character.isLetterOrDigit(c)) {
            if (!inWord) {
                inWord = true;
                wordCount++;
                System.out.println("Word count incremented to: " + wordCount);
            }
        } else {
            inWord = false;
        }
 ...
 */
 ...
 public static String reverse(String input) {
    ...
    for (int i = 0; i < length; i++) {
        reverseString[i] = input.charAt(length - 1 - i);
    }
...
public static String ReplaceChar(String original, String oldStr, String newStr) {
    ...
    for (int i = 0; i < length; i++) {
        // Check if the substring matches oldStr
        if (i <= length - oldLength && original.substring(i, i + oldLength).equals(oldStr)) {
            result += newStr; // Append newStr to result
            i += oldLength - 1; // Skip the length of oldStr
        } else {
            result += original.charAt(i); // Append the current character to result
        }
    }
            ...
            switch (choice) {
                ...
                do{
                    ...
                    while (true) {
                        ...
                        int wordcount = countWords(newinput);
                ...
                case 3:
                    do {
                        ...
                        String rep = ReplaceChar(newrep, charToReplace, replacementChar);
                ...
                case 6:
                    do {
                        System.out.println("Enter a string:");
                         String insplit = scanner.nextLine();
        
                         String[] words = splitString(insplit);
        
                         // Print the words in array format
                         System.out.print("[");
